  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>PT.Bintang R.M</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_persediaan") { echo "active"; } ?>">
              <a href="./?page=data_persediaan">
                <i class="fa fa-money"></i> <span>Persediaan</span> 
              </a>
            </li>
              <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_pelanggan") { echo "active"; } ?>">
              <a href="./?page=data_pelanggan">
                <i class="fa fa-file"></i> <span>Pelanggan</span> 
              </a>
            </li>
            <li class="treeview <?php if(isset($_GET['page']) && $_GET['page']=="data_penjualan") { echo "active"; } ?>">
              <a href="./?page=data_penjualan">
                <i class="fa fa-group"></i> <span>Penjualan</span> 
              </a>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">PT.Bintang Rejeki Maju</a></strong>
      </footer>
    </div><!-- ./wrapper -->
